    ...
    ChessChat.Conversation = Widget.extend({
        ...
        start: function() {
            ...
            if (cookie) {
                ...
                // Current user
                self.author_name = game.author_name;
                self.author_id = game.author_id;
                self.game_id = game.game_id;
                ready = session
                    .rpc("/chess/game/chat/history", {game_id: game.game_id})
                ...
                ready = session
                    .rpc("/chess/game/chat/init", {game_id: self.game_id})
        ...
        select_message: function() {
            ...
            if (message.data === "" || message.data === " ") {
                $(".chat #window_chat").append(
                    '<div class="error"><span class="fa fa-times">ERROR. Input message.</span></div>'
                );
                $(".chat #window_chat").each(function() {
                    this.scrollTop = this.scrollHeight;
                });

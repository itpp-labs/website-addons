...
odoo.define("chess.create_game", function(require) {
    ...
    CreateGame.GameStatusManager = Widget.extend({
        ...
        start: function() {
            var self = this;
            session
                .rpc("/chess/game/status/", {game_id: self.game_id})
                .then(function(result) {
                    ...
                    if (result == "Waiting") {
                        swal(
                            ...
                            "Your opponent can do it via Chess menu at the backend"
                        );
                    }
                    if (result == "Game Over") {
                        swal(
...
$(document).ready(function() {
    $(
        "#create_game #blitz, #play_with_a_friend #blitz, #create_tournament #blitz"
    ).click(function() {
    ...
    $(
        "#create_game .limited_time, #play_with_a_friend .limited_time, #create_tournament .limited_time"
    ).click(function() {
        $("#create_game #time").show();
        $("#play_with_a_friend #time").show();
        $("#create_tournament #time").show();
    ...
    $(
        "#create_game #standart, #play_with_a_friend #standart, #create_tournament #standart"
    ).click(function() {

...
class WebsiteTheme(models.Model):
    ...
    converted_theme_addon = fields.Char(string="Theme's technical name", help="")
    ...
    def _autofill_deps(self):
        ...
        modules = (
            ...
            ._search_theme_dependencies(self.converted_theme_addon)
            .mapped("name")
        )
        ...
        try:
            ...
            pass
        return {"dependency_ids": [(6, 0, themes.ids)]}

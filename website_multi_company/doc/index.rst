...
Note: theme_common installation does not work if you install modules that depend on it in demo mode.To avoid this, you have to create database without demo data installation or you can comment out in manifest.ry of theme_common these lines:

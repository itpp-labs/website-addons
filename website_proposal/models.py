...
class WebsiteProposalTemplate(models.Model):
    ...
    _columns = {
        ...
        "res_model": fields.char(
            "Model", help="The database object this template will be applied to"
        ),
    }
...
class WebsiteProposal(models.Model):
    ...
    def _get_default_company(self):
        ...
        if not company_id:
            raise UserError(
                _("Error!"), _("There is no default company for the current user!")
            )
        return company_id
    ...
    _columns = {
        ...
        "template_id": fields.many2one(
            "website_proposal.template", "Quote Template", readonly=True
        ),
        "head": fields.text("Html head"),
        ...
        "res_model": fields.char(
            "Model", readonly=True, help="The database object this is attached to"
        ),
        ...
        "state": fields.selection(
            [("draft", "Draft"), ("rejected", "Rejected"), ("done", "Signed")]
        ),

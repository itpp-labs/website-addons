$(document).ready(function() {
    ...
    $("a.js_update_line_json").on("click", function(ev) {
        ...
        openerp
            .jsonRpc("/website_proposal/update_line", "call", {
                line_id: line_id[1],
    ...
    $("form.js_accept_json").submit(function(ev) {
        ...
        openerp
            .jsonRpc("/website_proposal/accept", "call", {
                proposal_id: parseInt(proposal_id[1]),
                token: token,
                signer: signer_name,
            ...
            .then(function(data) {
                ...
                window.location.href =
                    "/website_proposal/" + proposal_id[1] + "/" + token + "?message=3";
            });
        return false;
    });
